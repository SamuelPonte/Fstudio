        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoServico = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataSessao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    VisivelPortfolio = table.Column<bool>(type: "INTEGER", nullable: false),
                    DataCriacao = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fotografias_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Testemunhos_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ClienteId = table.Column<int>(type: "INTEGER", nullable: false),
                    FotografiaId = table.Column<int>(type: "INTEGER", nullable: false),
                    DataAdicao = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Descarregada = table.Column<bool>(type: "INTEGER", nullable: false),
                    DataDownload = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClienteFotografias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClienteFotografias_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClienteFotografias_Fotografias_FotografiaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClienteFotografias_ClienteId_FotografiaId",
                table: "ClienteFotografias",
                columns: new[] { "ClienteId", "FotografiaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClienteFotografias_FotografiaId",
                table: "ClienteFotografias",
                column: "FotografiaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contactos_Arquivado",
                table: "Contactos",
                column: "Arquivado");

            migrationBuilder.CreateIndex(
                name: "IX_Contactos_DataEnvio",
                table: "Contactos",
                column: "DataEnvio");

            migrationBuilder.CreateIndex(
                name: "IX_Contactos_Lido",
                table: "Contactos",
                column: "Lido");

            migrationBuilder.CreateIndex(
                name: "IX_Fotografias_CategoriaId",
                table: "Fotografias",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_Fotografias_Destaque",
                table: "Fotografias",
                column: "Destaque");

            migrationBuilder.CreateIndex(
                name: "IX_Fotografias_VisivelPortfolio",
                table: "Fotografias",
                column: "VisivelPortfolio");

            migrationBuilder.CreateIndex(
                name: "IX_Testemunhos_Aprovado",
                table: "Testemunhos",
                column: "Aprovado");

            migrationBuilder.CreateIndex(
                name: "IX_Testemunhos_ClienteId",
                table: "Testemunhos",
                column: "ClienteId");
        }
